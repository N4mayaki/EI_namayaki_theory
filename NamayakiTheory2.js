...
        });
        
        lemmaComplete = theory.createPermanentUpgrade(0, currency, lemmaCost);
        lemmaComplete.description = "Namayaki Theory 2を証明する";
        lemmaComplete.info = "Namayaki Theory 2を証明する";
